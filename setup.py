...
setup(
    ...
    install_requires=['traitlets<6.0,>=5.1.0','pyparsing<3', 'yacs', 'nuscenes-devkit', 'tabulate', 'timm==0.4.9', 'dataclasses', 'tensorboard', 'PyYAML', 'tqdm','ipython>=7.23.1', 'jupyterlab','wandb', 'torchpack', 'mpi4py', 'ipykernel', 'ipdb'],
