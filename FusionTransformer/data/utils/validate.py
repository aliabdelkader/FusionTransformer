    ...
    with torch.no_grad():
        for iteration, data_batch in enumerate(dataloader):
            ...
            if 'SCN' in cfg.DATASET_TARGET.TYPE:
                ...
                data_dict["lidar"] = data_dict["lidar"].cuda()
            ...
            seg_loss_2d = F.cross_entropy(preds['img_seg_logit'], data_batch['seg_label'])
            seg_loss_3d = F.cross_entropy(preds['lidar_seg_logit'], data_batch['seg_label']) # if model_3d else None
