...
class SemanticTorchpackTrainer(Trainer):
    ...
    def _run_step(self, feed_dict: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {'targets': targets,  **outputs, "filename": feed_dict["filename"], "seq": feed_dict["seq"], "voxel_coords": feed_dict["voxel_coords"]}
    ...
    def eval_step(self, preds, feed_dict):
        ...
        if self.cfg.MODEL.USE_FUSION:
            outputs['lidar_seg'] = self.prepare_outputs_for_eval(feed_dict=feed_dict, preds=preds['lidar_seg_logit'].argmax(1))
