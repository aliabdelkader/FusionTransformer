...
from torchpack.environ import set_run_dir, get_run_dir
...
def create_callbacks(callback_name: str = "", num_classes: int = 1, ignore_label: int = 0, output_tensor: str = ""):
    return [
        MeanIoU(name='MeanIoU/' + callback_name, num_classes=num_classes,
                ignore_label=ignore_label, output_tensor=output_tensor),
        # iouEval(name='iouEval/'+ callback_name, n_classes=num_classes, ignore=ignore_label, output_tensor=output_tensor),
        accEval(name='accEval/' + callback_name, n_classes=num_classes,
                ignore=ignore_label, output_tensor=output_tensor),
    ]
